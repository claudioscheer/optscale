...
class TestHavaIntegrationApi(TestApiBase):
    def setUp(self, version="v2"):
        ...
        user_roles = [{"user_id": self.auth_user, "role_purpose": "optscale_manager"}]
        ...
        patch(
            "rest_api.rest_api_server.controllers.base.BaseController." "get_user_id",
            return_value=self.auth_user,
        ).start()
        patch(
            "rest_api.rest_api_server.controllers.rule.RuleController." "create_rule"
        ).start()
